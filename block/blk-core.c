 ...
 */
static int check_plug_merge(struct task_struct *tsk, struct request_queue *q,
			    struct bio *bio)
{
...
void blk_finish_plug(struct blk_plug *plug)
{
	...
	while (!list_empty(&plug->list)) {
		...
		add_acct_request(q, rq, ELEVATOR_INSERT_SORT);
	}
