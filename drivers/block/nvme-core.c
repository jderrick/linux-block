...
static void *nvme_map_queue_on_cmb(struct nvme_dev *dev, int qid, int q_size,
							...
							int depth)
{
	...
	if (qid && NVME_CMB_SQS(dev->cmbsz) && dev->cmb)
		nvmeq->sq_cmds = nvme_map_queue_on_cmb(dev, qid,
